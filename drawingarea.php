...
<!--<script type="text/javascript" src="<?php echo $CFG->wwwroot.'/question/type/drawing/';?>extensions/ext-foreignobject.js"></script>-->
...
.qtype_drawing_color_divsquare{
  width:21px; height:21px; margin:4px; border:0px solid black; float: left;
...
.divSquarebrush{
  width:35%; height:20px; margin:4px; border:0px solid black; float: left;cursor: pointer; cursor: hand;
}
.qtype_drawing_size_pen{
  position: relative; width:25px; height:20px; margin:4px; border:0px solid white; float: left;cursor: pointer; cursor: hand;
}
.circleBase {
  border-radius: 50%;
...
<div id="menu_bar">
  ...
  <div class="menu">
    ...
    <div class="menu_list" id="file_menu">
      ...
      <!--<div id="tool_flatten" class="menu_item" onclick="ccc();">Flatten Drawing</div>-->

      <!--<div id="tool_fullscreen" class="menu_item">Full Screen</div>-->
  ...
  <div class="menu">
    ...
    <div class="menu_list"  id="object_menu">
      <div class="menu_item action_selected disabled" id="tool_move_top"><?php print_string('bringtofront', 'qtype_drawing');?> <span class="shortcut">⌘⇧↑</span></div>
      <div class="menu_item action_selected disabled" id="tool_move_up"><?php print_string('bringforward', 'qtype_drawing');?> <span class="shortcut">⌘↑</span></div>
      <div class="menu_item action_selected disabled" id="tool_move_down"><?php print_string('sendbackward', 'qtype_drawing');?> <span class="shortcut">⌘↓</span></div>
      <div class="menu_item action_selected disabled" id="tool_move_bottom"><?php print_string('sendtoback', 'qtype_drawing');?> <span class="shortcut">⌘⇧↓</span></div>
      <div class="separator"></div>
      ...
      <div class="separator"></div>
      <div class="menu_item action_path_convert_selected disabled" id="tool_topath"><?php print_string('converttopath', 'qtype_drawing');?></div>
      <div class="menu_item action_path_selected disabled" id="tool_reorient"><?php print_string('reorientpath', 'qtype_drawing');?></div>
    </div>
  </div>
...
<div id="tools_top" class="tools_panel">
  ...
  <div id="canvas_panel" class="context_panel">
    ...
    <!--<div id="drawingpreset_panel" class="context_panel clearfix">-->
  ...
  <div id="qtype_drawing_tool_color15" class="qtype_drawing_color_pallette" data-strokeorfill= "fill"><img src="images/paintbucket.png" width="22" height="22" alt="B"></div>
    ...
    <div id="where_iwant_tool_opacity"></div>
        <div class="stroke_tool draginput" id="strokestyle_div"  <?php if($reduced_mode == 1){?>style="display:none;"<?php }?>>
...
<span style="display:none">
  ...
  <!--<div class="clearfix"><br /></div>  -->
    ...
    <?php }?>
    <!--
    <label id="tool_undo" data-title="Delete Object" class="draginput">
      <span class="icon_label">Undo</span>
      <label><img src="images/undo.png" width="32" style="cursor:pointer;display: block;
    margin: 0 auto;" alt="X" title="Undo"></label>
    </label>
    <label id="tool_redo" data-title="Delete Object" class="draginput">
      <span class="icon_label">Delete</span>
      <label><img src="images/redo.png" width="32" style="cursor:pointer;display: block;
    margin: 0 auto;" alt="X" title="Redo"></label>
    </label>
-->

    <label id="tool_angle" data-title="<?php print_string('changerotationangle', 'qtype_drawing');?>" class="draginput" <?php echo $display_style_full;?>>
    ...
    <div id="dat_tool_opacity_pain"  <?php echo $display_style_full;?>><div class="clearfix"></div>
    ...
    <div class="toolset" id="tool_blur" data-title="<?php print_string('changeblur', 'qtype_drawing');?>"  <?php echo $display_style_full;?>>
      <label>
    ...
    <label id="cornerRadiusLabel" data-title="<?php print_string('changecornerradius', 'qtype_drawing');?>"  <?php echo $display_style_full;?>>
    ...
    <!--<div class="clearfix"></div>-->
    <div id="align_tools"  <?php echo $display_style_full;?>><div class="clearfix"></div>
  ...
  <div id="path_panel" class="context_panel clearfix"   <?php echo $display_style_full;?>>
  ...
  <div id="path_node_panel" class="context_panel clearfix">
    ...
    <div id="segment_type" class="draginput label">
      ...
      <select id="seg_type" data-title="Change Segment type">
        <option id="straight_segments" selected="selected" value="4"><?php print_string('straight', 'qtype_drawing');?></option>
...
<?php } ?>
  <!--<div class="tool_button" id="tool_fill" title="Fill Tool [F]"></div>-->


  <div id="color_tools" <?php if($reduced_mode == 1){?>style="display:none;"<?php }?>>
  ...
  <!--
    <div class="tool_button" id="tool_bucket" style="background:#2f2f2c"><img src="images/paintbucket.png" width="26" height="26" alt="U"></div>
  -->
    ...
    <!--<div class="tool_button" id="tool_fullscreenx" title="Fullscreen [F]"></div>-->
</div> <!-- tools_left -->
...
<ul id="cmenu_canvas" class="contextMenu">
  ...
  <li class="separator"><a href="#delete"><?php print_string('delete', 'qtype_drawing');?><span class="shortcut">⌫</span></a></li>
  <li class="separator"><a href="#group"><?php print_string('group', 'qtype_drawing');?><span class="shortcut">⌘G</span></a></li>
  <li><a href="#ungroup"><?php print_string('ungroup', 'qtype_drawing');?><span class="shortcut">⌘⇧G</span></a></li>
  <li class="separator"><a href="#move_front"><?php print_string('bringtofront', 'qtype_drawing');?><span class="shortcut">⌘⇧↑</span></a></li>
  <li><a href="#move_up"><?php print_string('bringforward', 'qtype_drawing');?><span class="shortcut">⌘↑</span></a></li>
...
//$(document).on("click", function(e) {  e.preventDefault();console.error("clicked outside"); } );


/*
$('div#textedit_dialog').on('dialogclose', function(event) {
  console.error("distro here!");
 $(this).dialog('destroy');
});*/
