...
//            || elem && elem.tagName == "path" && !multiselected) { // This was added in r1430, but not sure why
  ...
  //              var ref_data = Actions.getButtonData(opts.button);
	...
	// alert(document.getElementById('canvas_background').getAttribute("width"));

	      //document.getElementById('canvas_background').width = '200px';
        //  svgCanvas.updateCanvas(960, 720);

	  // svgCanvas.updateCanvas(true);
		//svgCanvas.changeCanvasSize();
	//$("#canvas_width").val(200);
   // $("#canvas_height").val(200);
	//svgCanvas.updateCanvas(200,200);
	  /*
		$("#canvas_width").val(document.getElementById('canvas_background').width);
		$("#canvas_height").val(document.getElementById('canvas_background').getAttribute("height"));
		svgCanvas.setResolution(document.getElementById('canvas_background').getAttribute("width"), document.getElementById('canvas_background').getAttribute("height"));
		svgCanvas.updateCanvas(true);
