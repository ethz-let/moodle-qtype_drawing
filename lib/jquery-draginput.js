...
$.fn.dragInput = function(cfg){
  return this.each(function(){
    ...
    this.stop = function() {
      ...
      completed = true;
      $(window).unbind("mousemove.draginput mouseup.draginput touchmove.draginput touchend.draginput");
      //
      lastY = 0;
      if (selectedElems[0]) {
    ...
    this.launch = function(e) {
      ...
      $(window).bind("mousemove.draginput", function(e){/*e.preventDefault();*/ e.stopPropagation(); e.preventDefault(); el.move(e, oy, parseFloat(val)); })
      $(window).bind("mouseup.draginput", function(e){/*e.preventDefault();*/e.stopPropagation(); e.preventDefault(); el.stop();})

      $(window).bind("touchmove.draginput", function(e){e.stopPropagation(); e.preventDefault(); el.move(e, oy, parseFloat(val)); })
      $(window).bind("touchend.draginput", function(e){e.stopPropagation(); e.preventDefault(); el.stop(); })
