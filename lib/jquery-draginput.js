...
$.fn.dragInput = function(cfg){
  return this.each(function(){
    ...
    this.launch = function(e) {
      ...
      $(window).bind("mousemove.draginput", function(e){/*e.preventDefault();*/ el.move(e, oy, parseFloat(val)); e.stopPropagation(); e.preventDefault();})
      $(window).bind("mouseup.draginput", function(e){/*e.preventDefault();*/ el.stop(); e.stopPropagation(); e.preventDefault();})

      $(window).bind("touchmove.draginput", function(e){el.move(e, oy, parseFloat(val));e.stopPropagation(); e.preventDefault(); })
      $(window).bind("touchend.draginput", function(e){el.stop(); e.stopPropagation(); e.preventDefault();})
