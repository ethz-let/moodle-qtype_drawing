      ...
      localization: /* alter these to change the text presented by the picker (e.g. different language) */
        {
          text:
          {
            title: qtype_drawing_str_drag_markers,
            newColor: qtype_drawing_str_new,
            currentColor: qtype_drawing_str_current,
            ok: qtype_drawing_str_ok,
            cancel: qtype_drawing_str_cancel
          },
          tooltips:
          {
            colors:
