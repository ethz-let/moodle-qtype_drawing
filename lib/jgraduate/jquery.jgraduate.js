      ...
      if ($this.paint.type == "none") {
        $this.paint = $.jGraduate.Paint({solidColor: 'ffffff'});
            ...
            $this.html('<ul class="jGraduate_tabs">' +
                    '<li class="jGraduate_tab_color jGraduate_tab_current" data-type="col">'+qtype_drawing_str_solidcolor+'</li>' +
                    '<li class="jGraduate_tab_lingrad" data-type="lg">'+qtype_drawing_str_lingrad+'</li>' +
                    '<li class="jGraduate_tab_radgrad" data-type="rg">'+qtype_drawing_str_radgrad+'</li>' +
                  '</ul>' +
