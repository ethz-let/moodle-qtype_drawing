...
$string['accepted_background_image_file_types'] = 'Aktzeptierte Dateitypen';
...
$string['drawingmode'] = 'Zeichnen Modus';
...
$string['backgroundheight'] = 'Höhe er Zeichnung';
...
$string['ungroupelements'] = 'Gruppe auflösen';
...
$string['changezoom'] = 'Vergrösserung ändern';
...
$string['defaultcanvaswidth_help'] = 'Standard Zeichenfläche (Canvas) Breite - Hilfe Informationen';
$string['defaultcanvasheight'] = 'Standard Zeichenfläche (Canvas) Höhe';
$string['defaultcanvasheight_help'] = 'Standard Zeichenfläche (Canvas) Höhe - Hilfe Informationen';
$string['allowteachertochosemode'] = 'Den Teachers erlauben, den Zeichnungsmodus zu wählen?';
$string['allowteachertochosemode_help'] = 'Den Teachers erlauben, den Zeichnungsmodus zu wählen? - Hilfe Informationen';
...
$string['generalfeedback_help'] = 'Hilfe für Allgemeines Feedback';
